...
public partial class dir1_Admin_Default : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        string checkuser = "select * from coordinator where co_email = '" + txtemail.Text + "' AND co_pwd = '"+txtcupass.Text+"' WHERE co_id= " + uid;
        ...
        else
        {
            try
            {
                string insertQuery = "UPDATE coordinator SET co_pwd = ";
