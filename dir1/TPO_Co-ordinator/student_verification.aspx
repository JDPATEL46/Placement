<%@ Page Title="" Language="C#" MasterPageFile="~/dir1/TPO_Co-ordinator/dashboard.master" AutoEventWireup="true" CodeFile="student_verification.aspx.cs" Inherits="dir1_TPO_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <script type="text/javascript">
        ...
        function load_data() {
            $("#stu_tbody").fadeOut(1);
            var temp = "../TPO/load_data.aspx?tb=signup";
        ...
        function accept(x) {
            var temp = "../TPO/load_data.aspx?tb=auth_signup&val=1&id=" + x;
        ...
        function reject(x) {
            ...
            $.ajax({
                method: "GET",
                url: "../TPO/load_data.aspx?tb=auth_signup&val=0&id=" + x,
                success: function (data) {
                    load_data();
                }
            });
        ...
        function upd_pc(x) {
            ...
            var temp = "../TPO/update.aspx?tn=stu_auth&v1=" + v1 + "&v2=" + v2 + "&v3=" + v3 + "&v4=" + v4 + "&v5=" + v5 + "&ref=" + x;
            alert(temp);
            $.ajax({
                type: "GET",
                url: temp,
