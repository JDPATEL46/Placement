...
public partial class dir1_TPO_Co_ordinator_Default : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                SqlConnection conn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=F:\PlacementMGT\placement_management.mdf;Integrated Security=True;Connect Timeout=30");
                conn.Open();
    ...
    protected void btnupdate_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            SqlConnection conn = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=F:\PlacementMGT\placement_management.mdf;Integrated Security=True;Connect Timeout=30");
            conn.Open();
            string q = "UPDATE coordinator set co_name = '" + txtname.Text + "',co_email = '" + txtmail.Text + "', co_cno = '" + txtcont.Text + "', br_id = '" + ddlbname.SelectedValue + "' WHERE co_id =" + uid;
