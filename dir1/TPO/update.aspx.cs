    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if(Request.QueryString["tn"]!= null)
        {
            if (Request.QueryString["tn"].ToString() == "stu_auth") {
                ...
                con.ConnectionString = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=F:\PlacementMGT\placement_management.mdf;Integrated Security=True;Connect Timeout=30";
                con.Open();
