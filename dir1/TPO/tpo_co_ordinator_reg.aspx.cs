...
public partial class dir1_Admin_Default : System.Web.UI.Page
{
    ...
    protected void btnsubmit_Click(object sender, EventArgs e)
    {
        ...
        con.Open();
        string checkuser = "select count(*) from coordinator where co_email = '" + txtmail.Text + "' OR co_cno = '" + txtcont.Text + "' ";
        ...
        else
        {
            try
            {
                ...
                string insertQuery = "insert into coordinator (co_name,co_email,co_cno,co_pwd,br_id) values (@co_name,@co_email,@co_cno,@co_pwd,@br_id)";
