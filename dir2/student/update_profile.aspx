...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
       ...
       <form method="post" runat="server"> 
           ...
           <div class="span4"><asp:TextBox ID="txtid" runat="server" Height="40" Width="400px" readonly="true"></asp:TextBox></div>
          ...
          <div class="span2"> <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ErrorMessage=" * Email id" ControlToValidate="txtemail" ForeColor="red"></asp:RequiredFieldValidator></div>
           ...
           <div class="span4"><asp:DropDownList ID="ddlbranch" Height="40px" Width="400px" runat="server" DataSourceID="SqlDataSource1" DataTextField="br_name" DataValueField="br_id" ForeColor="Black">                                            </asp:DropDownList>
       ...
       <asp:UpdatePanel runat="server" id="UpdatePanel" updatemode="Conditional">
           ...
           <ContentTemplate>
		    ...
		    <div class="span4"><asp:DropDownList ID="ddlsem" runat="server" Height="40px" Width="400px" ForeColor="Black">
         ...
         <asp:Asyncpostbacktrigger controlid="ddlsem" eventname="SelectedIndexChanged" />
           ...
           <div class="span2"> <asp:regularexpressionvalidator runat="server" ControlToValidate="txtenrol" errormessage="*Enter correct en_no" ValidationExpression="^[0][1-9]\d{9}$|^[1-9]\d{11}$" ForeColor="Red"></asp:regularexpressionvalidator> </div>
    <div class="span2"> <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ErrorMessage=" * en_no" ControlToValidate="txtenrol" ForeColor="red"></asp:RequiredFieldValidator>
               </div>
                </div>
           <div class="span12">
           <div class="span2"></div>
           ...
           <div class="span4"><asp:DropDownList ID="ddlstate" runat="server" Height="40px" Width="400px" DataTextField="st_name" DataValueField="st_name" AutoPostBack="True" ForeColor="Black"></asp:DropDownList>

                </div>                     </div>
           <div class="span12">
           <div class="span2"></div>
           <div class="span2"><b>City</b></div>
           <div class="span4"><asp:DropDownList ID="ddlcity" runat="server" Height="40px" Width="400px" DataTextField="ct_name" DataValueField="ct_name" ForeColor="Black"></asp:DropDownList>
           ...
           <div class="span4"><asp:TextBox ID="txtdob" runat="server" Height="40" Width="400px" TextMode="Date" ForeColor="Black"></asp:TextBox></div>
                     <div class="span2"> &nbsp &nbsp<asp:RequiredFieldValidator ID="RequiredFieldValidator9" runat="server" ErrorMessage="   * DOB" ControlToValidate="txtdob" ForeColor="red"></asp:RequiredFieldValidator><br />
                         <asp:RangeValidator ID="valrDate" runat="server" ControlToValidate="txtdob" MinimumValue="31/12/1980" MaximumValue="1/1/2005" Type="Date" ForeColor="Red" text=" * Invalid Date" Display="Dynamic"/>
                     </div>

           </div>
           <center>
           <asp:Button ID="txtupdate" class="btn btn-danger" Height="40px" Width="200px" runat="server" Text="Update" OnClick="txtupdate_Click" CausesValidation="false"/>
            </center>
                 </form>
</asp:Content>
